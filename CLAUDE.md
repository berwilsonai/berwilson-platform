...
| 4 staged intake sessions cannot be accepted until a name is typed — *LOI*, *Text*, *Due Diligence Letter*, *Energy Development Group* | 09-23 | **re-measured 09-24: still exactly 4** (2 need a project name, 2 an opportunity name). They are the only ones of 81 that batch approval cannot take |
...
| **Two Highland plat maps are scanned/image-only** (`Plat Map (02-0138-0000).pdf`, `(02-0140-0000)`) — the file is on the record and in Drive, but no text was extracted, so Ber AI cannot read them. Load a vision model in LM Studio and re-run the document pass to fix | 09-25 | as reported |
