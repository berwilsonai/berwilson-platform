...
- For the underlying email correspondence — what someone actually wrote, deals still sitting in the inbox, who said what: use search_email_threads, then get_email_thread
