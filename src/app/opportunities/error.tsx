...
export default function OpportunitiesError({ error, reset }: ErrorProps) {
  ...
  return (
    <div className="flex flex-col items-center justify-center py-20 text-center">
      ...
      <h2 className="text-lg font-semibold mb-2">Failed to load opportunities</h2>
      <p className="text-sm text-muted-foreground mb-6 max-w-sm">
        Could not fetch your opportunities. If you just deployed, make sure the
        opportunities migration has been applied to the database.
      </p>
