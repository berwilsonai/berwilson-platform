...
export default function AttentionError({ error, reset }: ErrorProps) {
  useEffect(() => {
    console.error(error)
  }, [error])
  ...
  return (
    <div className="flex flex-col items-center justify-center py-20 text-center">
      ...
      <h2 className="text-lg font-semibold mb-2">Failed to load attention items</h2>
      <p className="text-sm text-muted-foreground mb-6 max-w-sm">
        Could not fetch overdue items and blockers. Check your connection and try again.
      </p>
      <button
        onClick={reset}
