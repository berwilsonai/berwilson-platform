...
export default function TimelineError({ error, reset }: ErrorProps) {
  useEffect(() => {
    console.error(error)
  }, [error])
  ...
  return (
    <div className="flex flex-col items-center justify-center py-20 text-center">
      ...
      <h2 className="text-lg font-semibold mb-2">Failed to load timeline</h2>
      <p className="text-sm text-muted-foreground mb-6 max-w-sm">
        Could not assemble project dates. Check your connection and try again.
      </p>
      <button
        onClick={reset}
