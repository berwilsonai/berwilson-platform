...
export default function EditProjectError({ error, reset }: ErrorProps) {
  ...
  return (
    <div className="flex flex-col items-center justify-center py-20 text-center">
      ...
      <h2 className="text-lg font-semibold mb-2">Failed to load project editor</h2>
      <p className="text-sm text-muted-foreground mb-6 max-w-sm">
        Could not load the edit form. Check your connection and try again.
      </p>
