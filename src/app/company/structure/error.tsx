...
export default function CompanyStructureError({ error, reset }: ErrorProps) {
  useEffect(() => {
    console.error(error)
  }, [error])
  ...
  return (
    <div className="flex flex-col items-center justify-center py-20 text-center">
      ...
      <h2 className="text-lg font-semibold mb-2">Failed to load the org structure</h2>
      <p className="text-sm text-muted-foreground mb-6 max-w-sm">
        Could not fetch the entity architecture. Make sure the org_structure
