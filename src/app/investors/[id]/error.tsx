...
export default function InvestorDetailError({ error, reset }: ErrorProps) {
  ...
  return (
    <div className="flex flex-col items-center justify-center py-20 text-center">
      ...
      <h2 className="text-lg font-semibold mb-2">Failed to load this investor</h2>
      <p className="text-sm text-muted-foreground mb-6 max-w-sm">
        Something went wrong fetching this investor&apos;s details.
      </p>
