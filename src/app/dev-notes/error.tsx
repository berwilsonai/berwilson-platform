...
export default function DevNotesError({ error, reset }: ErrorProps) {
  useEffect(() => {
    console.error(error)
  }, [error])
  ...
  return (
    <div className="flex flex-col items-center justify-center py-20 text-center">
      ...
      <h2 className="text-lg font-semibold mb-2">Failed to load developer notes</h2>
      <p className="text-sm text-muted-foreground mb-6 max-w-sm">
        If you just deployed, make sure the <code>dev_notes</code> migration has been applied.
      </p>
      <button
        onClick={reset}
