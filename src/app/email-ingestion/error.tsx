...
export default function EmailIngestionError({ error, reset }: ErrorProps) {
  ...
  return (
    <div className="flex flex-col items-center justify-center py-20 text-center">
      ...
      <h2 className="text-lg font-semibold mb-2">Email Ingestion failed to load</h2>
      <p className="text-sm text-muted-foreground mb-6 max-w-sm">
        If you just deployed, make sure the email_intake migration has been applied to the database.
      </p>
