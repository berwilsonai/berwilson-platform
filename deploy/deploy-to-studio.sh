...
ssh "$STUDIO" "
  ...
  for plist in com.berwilson.platform com.berwilson.cron-daily-brief com.berwilson.cron-risk-scores com.berwilson.cron-email-sweep com.berwilson.cron-task-digest com.berwilson.cron-lead-sweep com.berwilson.cron-drive-sync com.berwilson.cron-drive-publish com.berwilson.cron-contacts-sync com.berwilson.cron-meet-import com.berwilson.cron-deal-intake \
    com.berwilson.cron-google-tasks com.berwilson.cron-drive-watch com.berwilson.cron-daily-digest com.berwilson.cron-pepper-note; do
